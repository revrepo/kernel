...
/*
 * bool tcp_revsw_snd_wnd_test_generic
 */
static bool tcp_revsw_snd_wnd_test_generic(const struct tcp_sock *tp,
...
static int __init tcp_revsw_register(void)
{
	...
	revsw_ctl_table_hdr = register_sysctl("temp", revsw_ctl_table);
